...
(wilder.set_option :pipeline
                   [(wilder.branch (wilder.python_file_finder_pipeline {:file_command [:fd
                                                                                       :-tf
                                                                                       :-H]
                                                                        :dir_command [:fd
                                                                                      :-td
...
(wilder.set_option :renderer
                   (wilder.popupmenu_renderer (wilder.popupmenu_border_theme {:highlighter (wilder.basic_highlighter)
