...
(import-macros {: use! : packer-setup : packer} :hibiscus.packer)
...
(packer (use :udayvir-singh/tangerine.nvim) ; Suporte à fennel
        ...
        (use :chiendo97/intellij.vim) (use :sainnhe/everforest)
        (use :wimstefan/vim-artesanal) (use :pappasam/papercolor-theme-slim)
        ...
        (use! :folke/noice.nvim ;
              :event :VimEnter :config #(require :plugins.noice) :requires
              [:MunifTanjim/nui.nvim :rcarriga/nvim-notify])
        ;; (use! :subnut/nvim-ghost.nvim :run
        ...
        (use! :brymer-meneses/grammar-guard.nvim ; Grammar guard
              ...
              :config #(let [g (require :grammar-guard)]
                        (g.init))) (use :alaviss/nim.nvim)
